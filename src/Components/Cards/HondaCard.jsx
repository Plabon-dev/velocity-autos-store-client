...
const HondaCard = ({car}) => {
    ...
    return (
        <div>
           <div className="card lg:card-side bg-base-100 shadow-xl w-10/12 mx-auto p-10">
                <figure className="h-96"><img src={car.image} alt="Album" /></figure>
