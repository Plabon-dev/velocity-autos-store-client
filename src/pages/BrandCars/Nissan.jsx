...
import NissanCards from "../../Components/Cards/NissanCards";
...
const Nissan = () => {
    ...
    const NissanCars = cars.filter(car => car.brand === "Nissan");
    console.log(NissanCars);
    ...
    return (
        <div className="bg-gradient-to-t from-[#d2d1cb] via-[#88a0ae] to-[#d2d1cb]">
            ...
            <div className="py-20">
            <h2 className="font-bold text-center text-[#2187ab] text-3xl mb-10">Available <span className="text-[#62535a]">Nissan</span> Cars </h2>  
            <div className="grid grid-cols-1 gap-10 content-center">
                {
                    NissanCars.map(car => <NissanCards
                        key={car._id}
                        car={car}
                    ></NissanCards>)
                }
