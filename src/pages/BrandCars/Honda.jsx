...
import HondaCard from "../../Components/Cards/HondaCard";
...
const Honda = () => {
    ...
    return (
        <div className="bg-gradient-to-t from-[#d2d1cb] via-[#88a0ae] to-[#d2d1cb]">
          ...
          <div className="py-20">
          <h2 className="font-bold text-center text-[#2187ab] text-3xl mb-10">Available <span className="text-[#62535a]">Honda</span> Cars </h2>  
          <div className="grid grid-cols-1 gap-10 content-center">
                {
                    HondaCars.map(car => <HondaCard
                        key={car._id}
                        car={car}
                    ></HondaCard>)
                }
